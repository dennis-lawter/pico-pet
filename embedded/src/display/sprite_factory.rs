...
pub fn new_menu_sprite(x: i32, y: i32) -> Sprite<'static> {
    Sprite::new(
        ...
        MENU_DIMENSIONS.w,
        MENU_DIMENSIONS.h,
        include_bytes!("../../sprite_raw/menu.png.data"),
    )
}
...
pub fn new_pomo_menu_sprite(x: i32, y: i32) -> Sprite<'static> {
    Sprite::new(
        ...
        include_bytes!("../../sprite_raw/pomo_menu.png.data"),
    )
}
...
pub fn new_inventory_sprite(x: i32, y: i32) -> Sprite<'static> {
    Sprite::new(
        ...
        include_bytes!("../../sprite_raw/inventory.png.data"),
    )
}
...
pub fn new_lofi_sprite(x: i32, y: i32) -> Sprite<'static> {
    Sprite::new(
        ...
        LOFI_DIMENSIONS.w,
        LOFI_DIMENSIONS.h,
        include_bytes!("../../sprite_raw/lofi.png.data"),
    )
}
